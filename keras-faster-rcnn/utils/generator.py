...
class OIDGen(Sequence):
    def __init__(self, json_file, batch_size=BATCH_SIZE, min_size=MIN_SIZE, max_size=MAX_SIZE):
...
class ValidationGen(OIDGen):
    ...
    def __init__(self,data_dir=VALIDATION_DIR, json_file='validaiton_level_1.json'): 
        self.dir = data_dir   
...
class TestGen(Sequence):
    def __init__(self, data_dir=TEST_DIR, batch_size=BATCH_SIZE, aug=MULTI_SCALE_TESTING):
        self.dir = data_dir
        self.batch_size = batch_size
        self.aug = aug
